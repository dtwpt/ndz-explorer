angular.module('ndzExplorer')
    ...
    var peerCount = $scope.peerCount = web3.net.peerCount;

    var blockTime = $scope.blockTime = (web3.eth.getBlock(blockNum).timestamp - web3.eth.getBlock(blockNum - 300).timestamp) / 300;
    var difficulty = $scope.difficulty = parseInt(web3.eth.getBlock(blockNum).difficulty); // You can sum up the last n-blocks and average; this is mathematically sound.
   
    var hashrate = $scope.hashrate = (difficulty / blockTime).toFixed(2);
